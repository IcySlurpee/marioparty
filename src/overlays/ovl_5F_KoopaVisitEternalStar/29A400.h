...
void func_800F6988_KoopaVisitEternalStar(omObjData*);
void func_800F6B3C_KoopaVisitEternalStar(void);
void func_800F6C34_KoopaVisitEternalStar(void);

typedef struct koopaStartSpace {
s16 amountOfTimesStartPassed;
s16 unk2;
} koopaStartSpace; //unknown size

extern s32 D_800F6C68_KoopaVisitEternalStar[];
