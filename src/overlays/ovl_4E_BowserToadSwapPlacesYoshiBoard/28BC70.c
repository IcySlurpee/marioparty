...
void func_800F6708_BowserToadSwapPlacesYoshiBoard(omObjData* arg0) {
    ...
    temp_s0->unk_18.x = sinf(arg0->trans.x * ((M_PI/180)));
    temp_s0 = D_800F7858_BowserToadSwapPlacesYoshiBoard;
    temp_s0->unk_18.z = cosf(arg0->trans.x * ((M_PI/180)));
    arg0->trans.x += 5.0f;
...
void func_800F67BC_BowserToadSwapPlacesYoshiBoard(void) {
    ...
    for (i = 0; i < 0x37; i++) {
        ...
        temp_s0->unk_24 = -sinf( ((i * 6) + 0x1E) * ((M_PI/180))) * 30.0f;
        if (i == 10) {
    ...
    for (i = 0, var_s2 = 0; i < 3;) {
        ...
        temp_s0_2->unk_24 = -sinf((var_s2 * ((M_PI/180)))) * 20.0f;
        temp_s0 = D_800F7840_BowserToadSwapPlacesYoshiBoard->unk_3C;
        temp_s0->unk_24 = -sinf((var_s2 * ((M_PI/180)))) * 20.0f;
