...
void func_800F66B4_PiranhaPlantStarStealPeachBoard(void) {
    ...
    if (GwPlayer[D_800F75E0_PiranhaPlantStarStealPeachBoard].stars == 0) {
        ...
        func_80021B14(*D_800F75E4_PiranhaPlantStarStealPeachBoard->unk_3C->unk_40, GwPlayer[GwCommon.boardWork[GwCommon.boardWork[14]]].character, 0x80);
        ...
        if (GwPlayer[GwCommon.boardWork[GwCommon.boardWork[14]]].stars < 99) {
            GwPlayer[GwCommon.boardWork[GwCommon.boardWork[14]]].stars++;
        }
        
        HuPrcSleep(0x24);
        func_80060468(0x443, GwPlayer[GwCommon.boardWork[GwCommon.boardWork[14]]].character);
        HuPrcSleep(0x30);
        func_80050160();
        GwCommon.boardWork[GwCommon.boardWork[14]] = -1;
    }
