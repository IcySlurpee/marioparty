...
void func_800F66AC_BowserToadSwapPlacesMarioBoard(f32 arg0) {
    ...
    if (GwCommon.boardWork[0] != 0) {
        ...
        temp_s0 = D_800F6DF4_BowserToadSwapPlacesMarioBoard;
        temp_s0->coords.z = (cosf(arg0 * (M_PI/180)) * 200.0f) + D_800F6DBC_BowserToadSwapPlacesMarioBoard.z;
        temp_s0 = D_800F6DF4_BowserToadSwapPlacesMarioBoard;
        temp_s0->unk_18.x = sinf(arg0 * (M_PI/180));
        temp_s0 = D_800F6DF4_BowserToadSwapPlacesMarioBoard;
        temp_s0->unk_18.z = cosf(arg0 * (M_PI/180));
        ...
        temp_s0->coords.x = temp->x - (sinf(arg0 * (M_PI/180)) * 200.0f);
        temp_s0 = D_800F6DF8_BowserToadSwapPlacesMarioBoard;
        temp_s0->coords.z = temp->z - (cosf(arg0 * (M_PI/180)) * 200.0f);
        temp_s0 = D_800F6DF8_BowserToadSwapPlacesMarioBoard;
        temp_s0->unk_18.x = -sinf(arg0 * (M_PI/180));
        var_s0 = D_800F6DF8_BowserToadSwapPlacesMarioBoard;
        var_s0->unk_18.z = -cosf(arg0 * (M_PI/180));
    } else {
        temp_s0 = D_800F6DF8_BowserToadSwapPlacesMarioBoard;
        temp = &D_800F6DBC_BowserToadSwapPlacesMarioBoard;
        temp_s0->coords.x = (sinf(arg0 * (M_PI/180)) * 200.0f) + temp->x;
        temp_s0 = D_800F6DF8_BowserToadSwapPlacesMarioBoard;
        temp_s0->coords.z = (cosf(arg0 * (M_PI/180)) * 200.0f) + D_800F6DBC_BowserToadSwapPlacesMarioBoard.z;
        temp_s0 = D_800F6DF8_BowserToadSwapPlacesMarioBoard;
        temp_s0->unk_18.x = sinf(arg0 * (M_PI/180));
        ...
        temp_s0->coords.x = temp->x - (sinf(arg0 * (M_PI/180)) * 200.0f);
        temp_s0 = D_800F6DF4_BowserToadSwapPlacesMarioBoard;
        temp_s0->coords.z = D_800F6DBC_BowserToadSwapPlacesMarioBoard.z - (cosf(arg0 * (M_PI/180)) * 200.0f);
        temp_s0 = D_800F6DF4_BowserToadSwapPlacesMarioBoard;
        temp_s0->unk_18.x = -sinf(arg0 * (M_PI/180));
