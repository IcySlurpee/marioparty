...
void func_800F66BC_BowserVisitPeachBoard(void) {
    ...
    if (GwPlayer[D_800F7180_BowserVisitPeachBoard].coins == 0) {
        ...
        func_8003E81C(D_800F7184_BowserVisitPeachBoard, 1, 0);
        func_8004F40C(D_800F7184_BowserVisitPeachBoard, 0, 2);
        func_8003E81C(D_800F718C_BowserVisitPeachBoard, 0, 0);
...
void func_800F6E18_BowserVisitPeachBoard(void) {
    ...
    D_800F7188_BowserVisitPeachBoard = CreateObject(0x80, NULL);
...
void func_800F6FBC_BowserVisitPeachBoard(void) {
    ...
    DestroyObject(D_800F718C_BowserVisitPeachBoard);
    DestroyObject(D_800F7184_BowserVisitPeachBoard);
    DestroyObject(D_800F7188_BowserVisitPeachBoard);
    func_8004F2EC();
}
